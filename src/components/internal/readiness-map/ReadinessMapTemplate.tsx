      ...
      <section className="rm-page">
        ...
        <div className="rm-footer">
          ...
          <p className="rm-footer-method">
            Диагностика опирается на целевые ориентиры ФГОС ДО и классические методики дошкольной педагогики
            (О.С. Жукова, Д.Б. Эльконин, А.М. Леушина, Е.В. Колесникова, В.В. Гербова, Т.Б. Филичева, М.М. Безруких,
            Л.А. Венгер, Л.И. Божович, М.Р. Гинзбург). Оценка отражает зону ближайшего развития ребёнка по
            Л.С. Выготскому, а не соответствие жёсткой норме, и носит рекомендательный характер.
          </p>
        </div>
