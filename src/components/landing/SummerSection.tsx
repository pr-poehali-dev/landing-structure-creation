...
const SHIFTS = [
  { id: 1, label: "Дино-смена",                 sub: "Путешествие по миру динозавров",                              dates: "1 июня — 12 июня",        month: "июнь",   icon: "https://cdn.poehali.dev/projects/806f3e0c-84d0-4138-96fe-1f0a9797bd1a/bucket/26ba9f35-f120-4fab-81d6-87696d2ba8e8.png", anim: "anim-wag",     color: "linear-gradient(135deg, rgba(255, 140, 0, 0.75) 0%, rgba(255, 87, 34, 0.75) 100%)" },
        ...
        <div className="container" style={{ position: "relative", zIndex: 1 }}>
          <div className="summer-inner">
            ...
            <p className="summer-sub">
              ...
              Можно купить абонемент на месяц, а можно на 2 недели (1 смену).
            </p>
