...
const SHIFTS = [
  { id: 1, label: "Дино-смена",                 sub: "Путешествие по миру динозавров",                              dates: "1 июня — 12 июня",        month: "июнь",   icon: "https://cdn.poehali.dev/projects/806f3e0c-84d0-4138-96fe-1f0a9797bd1a/bucket/26ba9f35-f120-4fab-81d6-87696d2ba8e8.png", anim: "anim-wag",     color: "rgba(52, 168, 83, 0.55)" },
